...
print(f"[INFO] Memotong {train_size} baris (50% masa lalu) untuk Tahap Training!")

# Gunakan .clone() untuk memutus dependensi memori GPU
...
print("Model Forensik Berhasil Disimpan!")